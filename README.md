...
For testing I used [Unity](https://www.throwtheswitch.org/unity)
and [francinette](https://github.com/xicodomingues/francinette).
...
The repo uses a [Pitchfork](https://joholl.github.io/pitchfork-website/)-inspired layout
...
However,
the school autochecker expects a flat directory
with all `.c` and `.h` files at the root next to the Makefile.
The build system bridges the two:
